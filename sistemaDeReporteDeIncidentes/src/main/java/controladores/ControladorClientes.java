...
public class ControladorClientes {
    ...
    public void altaCliente() {
        ...
        } else if (sesion.esUsuarioAreaComercial()) {
    ...
    public void bajaCliente() {
        if (!sesion.esUsuarioAreaComercial()) {
            ...
            if (clienteADarDeBaja != null) {
                ...
                for (Incidente incidente : clienteADarDeBaja.getIncidentes()) {
                    if (!incidente.getEstado().esResuelto()) {
                        throw new IllegalStateException("No se puede dar de baja al cliente. Hay incidentes no resueltos.");
                    }
                }

                List<Incidente> incidentes = clienteADarDeBaja.getIncidentes();
