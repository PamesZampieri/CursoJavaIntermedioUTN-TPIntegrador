...
public class ControladorIncidente {
    ...
    public void registrarIncidente() {
        ...
        } else if (sesion.esUsuarioMesaAyuda()) {
    ...
    private void enviarEmailAsignacionIncidente(String email) {
        System.out.printf("Enviando email a %s. Tiene asignado un incidente.%n%n", email);
    }

    private void enviarWhatsAppAsignacionIncidente(String telefono) {
        System.out.printf("Enviando whatsapp a %s. Tiene asignado un incidente.%n%n", telefono);
    }

    public void resolverIncidente() {
        if (!sesion.esUsuarioTecnico()) {
            System.out.println("Error, usted no dispone el permiso para realizar esta tarea.");
            System.out.println();

        } else if (sesion.esUsuarioTecnico()) {
            ...
            System.out.println("Seleccione su id para resolver el incidente: ");
            ...
            if (opcion == 1) {
                if (incidente == null) {
                    System.out.println("Error: El incidente no está asignado.");
                    return;
                }
                ...
                enviarEmailAlCliente(incidente.getCliente().getEmail());
            }
        }
    }

    private void enviarEmailAlCliente(String email) {
        System.out.printf("Enviando email a %s. Se ha resuelto su incidente.%n%n", email);
    }
}